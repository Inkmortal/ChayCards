      ...
      <style>
        {`
          ...
          @keyframes folder-glow {
            0%, 100% { box-shadow: 0 0 10px rgba(255, 121, 198, 0.2); }
            50% { box-shadow: 0 0 20px rgba(255, 121, 198, 0.4); }
          }
          .folder-receiving {
          ...
          >
            ...
            <div className="flex h-full">
              <div className="w-40 flex items-center justify-center">
                {item.type === 'folder' ? (
                  <Icon name="folder" className="w-16 h-16 text-primary transition-transform duration-200 group-hover:scale-110" />
                ) : (
                  <Icon name="document" className="w-16 h-16 text-text-lighter transition-transform duration-200 group-hover:scale-110" />
                )}
              </div>
              <div className="flex-1 flex flex-col justify-center pr-12">
                <div>
                  <h3 
                    className="text-2xl font-medium text-text truncate" 
                    title={item.name}
                  >
                    {item.name}
                  </h3>
